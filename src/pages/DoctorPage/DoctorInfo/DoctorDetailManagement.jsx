...
import { getAllDoctorScheduleByDoctorId } from "../../../apis/bookingService";
...
const DoctorDetailManagement = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        // Lấy lịch làm việc
        // const resSchedule = await getAllDoctorScheduleByDoctorId(doctorId);
  ...
  const statusName = doctor?.status?.statusName;

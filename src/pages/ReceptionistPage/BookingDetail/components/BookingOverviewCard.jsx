// File: pages/ReceptionistPage/components/BookingOverviewCard.jsx
  ...
  return (
    ...
    >
      ...
      <Row justify="space-between" gutter={[16, 16]} style={{ marginBottom: 16 }}>
        <Col xs={24} md={12}>
          <Typography.Text type="secondary" style={{ fontSize: 12 }}>Ngày tạo:</Typography.Text>
          <br />
          <Typography.Text>{data?.createAt}</Typography.Text>
        </Col>
        <Col xs={24} md={8} mdOffset={4}>
          <div style={{ textAlign: "left" }}>
            <Typography.Text type="secondary" style={{ fontSize: 12 }}>Mã đặt lịch:</Typography.Text>
            <br />
